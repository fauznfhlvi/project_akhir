          ...
          <div class="card-wrapper">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  <label class="form-control-label" for="name">Tipe Mobil:</label>
                  <input type="text" name="tipe" value="<?php echo set_value('name', $product->tipe); ?>" class="form-control" id="name">
