        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <ul class="ftco-footer-social list-unstyled float-md-center float-lft mt-5" >
              <center>
              <li class="ftco-animate"><a href="https://api.whatsapp.com/send?phone=+628811613088&text=saya ingin melakukan pembelian mobil." target='_BLANK'><span
              ...
              <li class="ftco-animate"><a href="https://x.com/fauznfhlvi13?t=HlCLIs2xsq6dKIXZ0c58FQ&s=09" target='_BLANK'><span
                                        class="icon-twitter"></span></a></li>
              <li class="ftco-animate"><a href="https://www.instagram.com/restumobilindo_?igsh=ZWZ6dDNoZ2NlYTdy"><span class="icon-instagram"></span></a></li>
           ...
           <div class="ftco-footer-widget mb-4">
            ...
            <div class="d-flex">
                <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                  ...
                  <li><a href="<?php echo site_url('reviews/reviews'); ?>" class="py-2 d-block">Testimoni Pelanggan</a></li>
                </ul>
              </div>
          </div>
        </div>
